function analysislottery(matrixA)
...
% show top 10 numbers less sorted
%figure
%bar(orderfreqnum(1:5,2),orderfreqnum(1:5,1));
printf("-----\n");
printf("Frequency\tNumber - in the last %d games \n",ngames);
printf("-----\n");
...
% show bottom 10 numbers less sorted (top 5 most sorted)
%figure
%bar(orderfreqnum(totsize-5:totsize,2),orderfreqnum(totsize-5:totsize,1));

%for i=totsize-10:totsize
%	printf("%d\t%d\n",orderfreqnum(i,2),orderfreqnum(i,1));
%endfor
